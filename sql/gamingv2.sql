...
create table usuarios (email varchar(50) not null, nombre varchar(20) not null, apellido varchar(20) not null,
 contra varchar(20)	, fecha_alta date not null, vetado date, pc_reservados int not null, permisos int ) ENGINE=InnoDB DEFAULT CHARSET=latin1;

alter table usuarios add constraint pk_usuarios primary key (email);

insert into usuarios (email , nombre , apellido , contra , fecha_alta , vetado, pc_reservados, permisos ) values
